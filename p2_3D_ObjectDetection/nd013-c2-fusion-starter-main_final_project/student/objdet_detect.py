...
def create_model(configs):
    ...
    if (configs.arch == 'darknet') and (configs.cfgfile is not None):
        ...
        num_layers = 18 # according to resnet_spec in /tools/objdet_models/resnet/models/fpn_resnet.py
...
def detect_objects(input_bev_maps, model, configs):
    ...
    with torch.no_grad():  
        ...
        if 'darknet' in configs.arch:
            ...
            detections = detections[0][1] # requirements of data structure according to project instructions step 3
            #######
            ####### ID_S3_EX1-5 END #######     
